  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-100 p-6 rounded-lg shadow-lg border border-gray-700">
          <h2 className="text-slate-600 text-lg mb-2">Total Posts</h2>
          <p className="text-4xl font-bold text-purple-400">{stats.posts}</p>
        </div>

        <div className="bg-slate-100 p-6 rounded-lg shadow-lg border border-gray-700">
          <h2 className="text-slate-600 text-lg mb-2">Total Courses</h2>
          <p className="text-4xl font-bold text-blue-400">{stats.courses}</p>
        </div>

        <div className="bg-slate-100 p-6 rounded-lg shadow-lg border border-gray-700">
          <h2 className="text-slate-600 text-lg mb-2">Messages</h2>
